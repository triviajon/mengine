...
void test_parse_definition_single_param(void) {
    ...
    assert_equal_str("x", cmd->as.defn.params[0]->name,
...
void test_parse_definition_multiple_params(void) {
    ...
    assert_equal_str("A", cmd->as.defn.params[0]->name,
                     "first param should be 'A'");
    assert_equal_str("x", cmd->as.defn.params[1]->name,
...
void test_parse_theorem(void) {
    ...
    assert_equal_int(STMT_KW_THEOREM, cmd->as.stmt.kw,
                     "keyword should be THEOREM");
...
void test_parse_definition_lambda_body(void) {
    ...
    assert_not_null(cmd->as.defn.body, "body should exist");
    assert_equal_int(AST_LAMBDA, cmd->as.defn.body->tag,
...
void test_parse_lemma_complex(void) {
    ...
    assert_not_null(cmd->as.stmt.type, "type should exist");
    assert_equal_int(AST_FORALL, cmd->as.stmt.type->tag,
                     "type should be forall");
}
